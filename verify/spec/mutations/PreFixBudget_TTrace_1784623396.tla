---- MODULE PreFixBudget_TTrace_1784623396 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PreFixBudget_TTrace_1784623396.json", _TETrace)
...
\*
\*trace == IODeserialize("PreFixBudget_TTrace_1784623396.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([journaled |-> <<{"b1", "b2", "b3"}, {}, {}, {}>>,cancelReq |-> <<FALSE, FALSE, FALSE, FALSE>>,freshAttempt |-> <<FALSE, FALSE, FALSE, FALSE>>,spent |-> <<6, 0, 0, 0>>,execCount |-> <<[b1 |-> 1, b2 |-> 1, b3 |-> 1, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0]>>,clock |-> 0,state |-> <<"running", "absent", "absent", "absent">>,attempt |-> <<1, 0, 0, 0>>,live |-> <<FALSE, FALSE, FALSE, FALSE>>]),
    ([journaled |-> <<{"b1", "b2", "b3"}, {}, {}, {}>>,cancelReq |-> <<FALSE, FALSE, FALSE, FALSE>>,freshAttempt |-> <<FALSE, FALSE, FALSE, FALSE>>,spent |-> <<6, 0, 0, 0>>,execCount |-> <<[b1 |-> 1, b2 |-> 1, b3 |-> 1, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0], [b1 |-> 0, b2 |-> 0, b3 |-> 0, b4 |-> 0, t1 |-> 0, s1 |-> 0, s2 |-> 0]>>,clock |-> 0,state |-> <<"ready", "absent", "absent", "absent">>,attempt |-> <<1, 0, 0, 0>>,live |-> <<FALSE, FALSE, FALSE, FALSE>>]),
...
---- CONFIG PreFixBudget_TTrace_1784623396 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 10:43:17 CEST 2026