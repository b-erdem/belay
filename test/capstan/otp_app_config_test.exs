defmodule Capstan.OtpAppConfigTest do
  ...
  test "inline opts override the application-env base (runtime values win)" do
    ...
    assert {Capstan.Storage.Memory, _} = config.storage
  after
    Application.delete_env(:capstan_cfg_test, MyApp.Cap2)
  end
